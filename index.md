...
This is a research group led by [Dr Avinash Sharma](/about/), affiliated with the [Centre for Visual Information Technology (CVIT)](http://cvit.iiit.ac.in), IIIT Hyderabad. We primarily work on the computer vision and machine learning problems with a focus on 3D scene understanding and reconstruction. Specifically, we deal with problems where human body is reconstructed from 2D images and analysed in 3D, registration of point clouds of indoor scenes captured from commodity sensors as well as large outdoor scenes captured from LIDAR scanners. 
